...
context.load_cert_chain('private_key.crt', 'private_key.key')

app.config['SECRET_KEY'] = '5645y4bhbfghn65u6yjr5gthujy67ubnhujy76yb'
app.config['MONGO_URI'] = 'mongodb://localhost:8080/mydb'  # MongoDB connection URL
